...
module Gibier
  ...
  class Slide
    ...
    def render
      if window_height / window_width < SLIDE_HEIGHT / SLIDE_WIDTH
        zoom = window_height / SLIDE_HEIGHT
        left = (window_width / zoom - SLIDE_WIDTH) / 2
        top = 0
      else
        zoom = window_width / SLIDE_WIDTH
        left = 0
