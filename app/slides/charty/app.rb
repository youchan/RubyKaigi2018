require 'slide'
require 'page_base'
require 'slides/charty/pages'
require 'opal/websocket'

Gibier.slide_name = 'charty'
...
$document.ready do
  ws = Opal::WebSocket.new("ws://#{`window.location.host`}/push_notification/start/slide/charty") unless Gibier.gh_pages
